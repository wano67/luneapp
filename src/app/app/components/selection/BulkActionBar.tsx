...
export function BulkActionBar({ count, onClear, actions }: BulkActionBarProps) {
  ...
  return (
    <div className="sticky top-0 z-10 flex flex-wrap items-center justify-between gap-3 rounded-xl border border-[var(--border)] bg-[var(--surface)]/90 p-3 backdrop-blur">
