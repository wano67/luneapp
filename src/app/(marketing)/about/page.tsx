...
export const metadata: Metadata = {
  title: 'À propos • Lune',
  description: 'Pourquoi Lune : un produit calme pour les indépendants et petites équipes qui jonglent entre pro et perso.',
};
    ...
    <div className="space-y-12">
      ...
      <section className="space-y-4">
        ...
        <p className="max-w-2xl text-base leading-relaxed text-[var(--text-secondary)]">
          Lune est né d&apos;un constat simple : les freelances et gérants de petites structures
          jonglent chaque semaine entre outils pro, tableurs personnels et apps bancaires. Le résultat
          est bruyant, éparpillé et chronophage. Lune réunit tout ça en un seul espace calme — sans
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card className="border-[var(--border)] bg-[var(--surface)] p-5">
            ...
            <p className="mt-2 text-sm leading-relaxed text-[var(--text-secondary)]">
              Freelances, consultants, créatifs : Lune leur donne un cockpit pro complet (prospects,
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <Card key={v.tag} className="border-[var(--border)] bg-[var(--surface)] p-5">
