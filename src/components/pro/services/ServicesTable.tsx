...
export function ServicesTable({ services, businessId, isAdmin, onEdit, onDelete, onCreateFirst }: Props) {
        ...
        {services.map((service) => (
          <TableRow key={service.id}>
            ...
            <TableCell className="hidden lg:table-cell">
              <Link
                href={`/app/pro/${businessId}/services/${service.id}?tab=templates`}
