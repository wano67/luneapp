...
export type QuoteEditorModalLine = {
  id: string;
  label: string;
  description: string;
  quantity: string;
...
export type QuoteEditorModalState = {
  quoteId: string;
  status: string;
  number: string | null;
  issuedAt: string;
  expiresAt: string;
  note: string;
  lines: QuoteEditorModalLine[];
};

export type QuoteEditorModalProps = {
  editor: QuoteEditorModalState | null;
  isAdmin: boolean;
  canEditMeta: boolean;
  ...
  onChangeLine: (lineId: string, patch: Partial<QuoteEditorModalLine>) => void;
};
